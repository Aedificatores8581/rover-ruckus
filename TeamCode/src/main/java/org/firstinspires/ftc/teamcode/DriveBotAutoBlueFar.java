...
public class DriveBotAutoBlueFar extends DriveBotTestTemplate {
    ...
    //DRIVE TO LAST = 1050
    //350 to ram
    int timeToDispense, encToDispense = 1375, encToRamGlyph = 1000, encToBackUp = 440, encToBackUpAgain = 400, encToDismount = 960, encToMoveToLeft = 210, encToChangeColumn = 0, encToMoveToCenter = 210 + 325, encToMoveToRight = 210 + 325 + 400;
