...
public abstract class OldBotTemplate extends OpMode {
    ...
    protected GlyphInOutIntakeState glyphInOutIntakeState;
    protected GlyphInOutIntakeState prevGlyphInOutIntakeState;
    ...
    protected DcMotor leftFore, leftRear, rightFore, rightRear;
    protected DcMotor dispenserLinearSlide;
    protected DcMotor relicArm;

    protected DcMotor glyphLift;
    protected DigitalChannel glyphLiftHigh, glyphLiftLow;
    protected DistanceSensor intakeSensorRange;
    protected NormalizedColorSensor intakeSensorColor;
    ...
    protected CRServo belt1, belt2;

    protected Servo jewelArm, jewelFlipper, relicHand, relicFingers, glyphOutput, rIntake, lIntake;

    protected NormalizedColorSensor color, colorL;
    protected NormalizedRGBA colors;


    protected BNO055IMU imu;
    protected AnalogInput ampSensor;
