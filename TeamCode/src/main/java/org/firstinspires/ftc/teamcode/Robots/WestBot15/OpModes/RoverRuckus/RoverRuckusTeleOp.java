...
@TeleOp(name = "RR2 Teleop", group = "Rover Ruckus")
public class RoverRuckusTeleOp extends WestBot15 {
    boolean canSwitch = false;

    private boolean markerDropped, ended, endgame = false;

    private double prevRightStick1;
    private double ratchetTimer = 0;

    private AExtendotm aextendo;
    private Intake intaek;
    private Lift lift;
    ...
    public void loop() {
        ...
        if (gamepad2.left_stick_button && gamepad2.right_stick_button) { endgame = true; }
        ...
        if (!endgame) {
            ...
            if (gamepad1.left_stick_button) {
                ...
                drivetrain.maxSpeed = 3.5 * rightStick1.x;
            }
            ...
            if (gamepad2.right_trigger > UniversalConstants.Triggered.TRIGGER && gamepad2.left_trigger > UniversalConstants.Triggered.TRIGGER) {
                ...
                if (Math.signum(prevRightStick1) != Math.signum(prevRightStick1)) { lift.switchRatchetState(); }
