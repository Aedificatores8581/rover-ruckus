...
public class DriveBotAutoBlueNear extends DriveBotTemplate {
    ...
    enum State {
        ...
        STATE_DRIVE_TO_CRYPTOBOX, // Ends when short-range distance sensor reads cryptobox divider. Always -> STATE_FACE_CRYPTOBOX
        STATE_FACE_CRYPTOBOX, // Ends when gyro sensor reads a change of 90 degrees. Always -> STATE_CRYPTOBOX_LEFT_SLOT
