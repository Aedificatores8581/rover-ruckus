...
public class CrabBotDriveTest extends SwerveBotTemplate {
    double angleOfRotation, I, II, III, IV, max, desiredAngle, desiredPos, xl, yl, yr, xr, mult, cmAngle;
    double botAngle;
    double turnDir;
    double turnMult;
    ...
    final double I_TURN_ANGLE = 0;
    final double II_TURN_ANGLE = 0;
    final double III_TURN_ANGLE = 0;
    final double IV_TURN_ANGLE = 0;
    final double TURN_MULT = 0.75;
    final double TANK_POS = 1.0;
    final double ANGLE_THRESHHOLD = 1;
    @Override
    public void init() {
        super.init();
        encPos = 0;
