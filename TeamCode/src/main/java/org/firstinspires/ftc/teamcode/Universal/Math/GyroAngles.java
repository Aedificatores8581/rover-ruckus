...
public class GyroAngles {
    ...
    public double refreshGyroAnglesRadiansZ(Orientation angles){
        z = AngleUnit.RADIANS.fromUnit(AngleUnit.RADIANS, angles.firstAngle);
        y = AngleUnit.RADIANS.fromUnit(AngleUnit.RADIANS, angles.secondAngle);
        x = AngleUnit.RADIANS.fromUnit(AngleUnit.RADIANS, angles.thirdAngle);
        return z;
    }
